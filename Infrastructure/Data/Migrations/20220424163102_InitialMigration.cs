        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsRatio = table.Column<bool>(type: "INTEGER", nullable: false),
                    Ratio = table.Column<decimal>(type: "decimal(19,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    Definition = table.Column<string>(type: "TEXT", nullable: false),
                    DiscountDefinitionId = table.Column<int>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerTypes_DiscountDefinitions_DiscountDefinitionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerTypes_DiscountDefinitionId",
                table: "CustomerTypes",
